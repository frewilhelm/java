...
public class CentroidPoint extends Point implements InterfaceCentroid {
	 ...
	 * @return
	 */
	public static List<InterfaceCentroid> randomCentroids(List<Object> list, List<InterfaceCentroid> centroids, int amountOfCentroids) 
	{
		if(amountOfCentroids > list.size())
		{
			System.out.println("You chose to many centroids..");
			System.exit(1); // break code-compilation
		}
